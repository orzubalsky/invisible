...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextChunkWork.text'
        db.alter_column(u'audiobook_textchunkwork', 'text', self.gf('tinymce.models.HTMLField')())
        # Adding field 'Chunk.text'
        db.add_column(u'audiobook_chunk', 'text',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TextChunkWork.text'
        db.alter_column(u'audiobook_textchunkwork', 'text', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Chunk.text'
        db.delete_column(u'audiobook_chunk', 'text')
